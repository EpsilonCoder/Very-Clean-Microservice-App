...
public class SpecialitesPersonnelResource {
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PatchMapping(value = "/specialites-personnels/{id}", consumes = { "application/json", "application/merge-patch+json" })
    public ResponseEntity<SpecialitesPersonnel> partialUpdateSpecialitesPersonnel(
        ...
        Optional<SpecialitesPersonnel> result = specialitesPersonnelRepository
            ...
            .map(existingSpecialitesPersonnel -> {
    ...
    public ResponseEntity<List<SpecialitesPersonnel>> getAllSpecialitesPersonnels(
