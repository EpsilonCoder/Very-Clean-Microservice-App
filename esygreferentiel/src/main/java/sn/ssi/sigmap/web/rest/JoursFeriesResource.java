...
public class JoursFeriesResource {
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PatchMapping(value = "/jours-feries/{id}", consumes = { "application/json", "application/merge-patch+json" })
    ...
    public ResponseEntity<List<JoursFeries>> getAllJoursFeries(@org.springdoc.api.annotations.ParameterObject Pageable pageable) {
