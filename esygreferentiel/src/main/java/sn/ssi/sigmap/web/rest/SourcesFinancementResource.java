...
public class SourcesFinancementResource {
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PatchMapping(value = "/sources-financements/{id}", consumes = { "application/json", "application/merge-patch+json" })
    public ResponseEntity<SourcesFinancement> partialUpdateSourcesFinancement(
        ...
        Optional<SourcesFinancement> result = sourcesFinancementRepository
            ...
            .map(existingSourcesFinancement -> {
                if (sourcesFinancement.getCode() != null) {
                    existingSourcesFinancement.setCode(sourcesFinancement.getCode());
                }
                if (sourcesFinancement.getLibelle() != null) {
                    existingSourcesFinancement.setLibelle(sourcesFinancement.getLibelle());
                }
                if (sourcesFinancement.getCorbeille() != null) {
                    existingSourcesFinancement.setCorbeille(sourcesFinancement.getCorbeille());
                }
    ...
    public ResponseEntity<List<SourcesFinancement>> getAllSourcesFinancements(
