...
public class PersonnesRessourcesResource {
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PatchMapping(value = "/personnes-ressources/{id}", consumes = { "application/json", "application/merge-patch+json" })
    public ResponseEntity<PersonnesRessources> partialUpdatePersonnesRessources(
        ...
        Optional<PersonnesRessources> result = personnesRessourcesRepository
            ...
            .map(existingPersonnesRessources -> {
    ...
    public ResponseEntity<List<PersonnesRessources>> getAllPersonnesRessources(
