...
public class CategorieFournisseurResource {
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PatchMapping(value = "/categorie-fournisseurs/{id}", consumes = { "application/json", "application/merge-patch+json" })
    public ResponseEntity<CategorieFournisseur> partialUpdateCategorieFournisseur(
        ...
        Optional<CategorieFournisseur> result = categorieFournisseurRepository
            ...
            .map(existingCategorieFournisseur -> {
    ...
    public ResponseEntity<List<CategorieFournisseur>> getAllCategorieFournisseurs(
