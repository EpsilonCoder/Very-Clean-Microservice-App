...
/**
 * REST controller for managing {@link sn.ssi.sigmap.domain.Fournisseur}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class FournisseurResource {
    ...
    private static final String ENTITY_NAME = "referentielmsFournisseur";
    ...
    public ResponseEntity<Fournisseur> partialUpdateFournisseur(
        ...
        Optional<Fournisseur> result = fournisseurRepository
            ...
            .map(existingFournisseur -> {
                if (fournisseur.getRaisonSociale() != null) {
                ...
                if (fournisseur.getPieceJointe() != null) {
                    existingFournisseur.setPieceJointe(fournisseur.getPieceJointe());
                }
                if (fournisseur.getNumeroRegistreCommerce() != null) {
                    existingFournisseur.setNumeroRegistreCommerce(fournisseur.getNumeroRegistreCommerce());
                }
                if (fournisseur.getDate() != null) {
                    existingFournisseur.setDate(fournisseur.getDate());
                }
                if (fournisseur.getSigle() != null) {
                    existingFournisseur.setSigle(fournisseur.getSigle());
                }
                if (fournisseur.getNumeroIdentiteFiscale() != null) {
                    existingFournisseur.setNumeroIdentiteFiscale(fournisseur.getNumeroIdentiteFiscale());
                }
