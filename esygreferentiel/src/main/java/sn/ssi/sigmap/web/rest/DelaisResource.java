...
public class DelaisResource {
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PatchMapping(value = "/delais/{id}", consumes = { "application/json", "application/merge-patch+json" })
     ...
     */
    @GetMapping("/delais")
    public ResponseEntity<List<Delais>> getAllDelais(@org.springdoc.api.annotations.ParameterObject Pageable pageable) {
