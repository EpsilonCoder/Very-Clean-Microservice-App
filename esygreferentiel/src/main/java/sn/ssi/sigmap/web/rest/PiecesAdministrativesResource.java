...
public class PiecesAdministrativesResource {
    ...
    public ResponseEntity<PiecesAdministratives> createPiecesAdministratives(
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PatchMapping(value = "/pieces-administratives/{id}", consumes = { "application/json", "application/merge-patch+json" })
    public ResponseEntity<PiecesAdministratives> partialUpdatePiecesAdministratives(
        ...
        Optional<PiecesAdministratives> result = piecesAdministrativesRepository
            ...
            .map(existingPiecesAdministratives -> {
                ...
                if (piecesAdministratives.getDescription() != null) {
                    existingPiecesAdministratives.setDescription(piecesAdministratives.getDescription());
                }
                ...
                if (piecesAdministratives.getType() != null) {
                    existingPiecesAdministratives.setType(piecesAdministratives.getType());
                }
    ...
    public ResponseEntity<List<PiecesAdministratives>> getAllPiecesAdministratives(
