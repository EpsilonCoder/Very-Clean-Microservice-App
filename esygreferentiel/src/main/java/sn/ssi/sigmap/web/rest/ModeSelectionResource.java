...
public class ModeSelectionResource {
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PatchMapping(value = "/mode-selections/{id}", consumes = { "application/json", "application/merge-patch+json" })
    ...
    public ResponseEntity<List<ModeSelection>> getAllModeSelections(@org.springdoc.api.annotations.ParameterObject Pageable pageable) {
