...
class BanqueResourceIT {
    ...
    void createBanque() throws Exception {
        ...
        restBanqueMockMvc
            .perform(
                post(ENTITY_API_URL).with(csrf()).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(banque))
            )
    ...
    void putWithMissingIdPathParamBanque() throws Exception {
        ...
        restBanqueMockMvc
            .perform(
                put(ENTITY_API_URL).with(csrf()).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(banque))
            )
    ...
    void deleteBanque() throws Exception {
        ...
        // Delete the banque
        restBanqueMockMvc
            .perform(delete(ENTITY_API_URL_ID, banque.getId()).with(csrf()).accept(MediaType.APPLICATION_JSON))
