...
class DelaisResourceIT {
    ...
    void createDelais() throws Exception {
        ...
        restDelaisMockMvc
            .perform(
                post(ENTITY_API_URL).with(csrf()).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(delais))
            )
    ...
    @Test
    @Transactional
    void putExistingDelais() throws Exception {
        // Initialize the database
        delaisRepository.saveAndFlush(delais);
    ...
    void putNonExistingDelais() throws Exception {
        ...
        restDelaisMockMvc
            .perform(
                put(ENTITY_API_URL_ID, delais.getId())
                    .with(csrf())
                    .contentType(MediaType.APPLICATION_JSON)
    ...
    void putWithMissingIdPathParamDelais() throws Exception {
        ...
        restDelaisMockMvc
            .perform(
                put(ENTITY_API_URL).with(csrf()).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(delais))
            )
    ...
    void deleteDelais() throws Exception {
        ...
        // Delete the delais
        restDelaisMockMvc
            .perform(delete(ENTITY_API_URL_ID, delais.getId()).with(csrf()).accept(MediaType.APPLICATION_JSON))
