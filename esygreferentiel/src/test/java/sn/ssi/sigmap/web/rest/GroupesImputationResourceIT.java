...
class GroupesImputationResourceIT {
    ...
    @Test
    @Transactional
    void putExistingGroupesImputation() throws Exception {
        // Initialize the database
        groupesImputationRepository.saveAndFlush(groupesImputation);
    ...
    void deleteGroupesImputation() throws Exception {
        ...
        restGroupesImputationMockMvc
            .perform(delete(ENTITY_API_URL_ID, groupesImputation.getId()).with(csrf()).accept(MediaType.APPLICATION_JSON))
