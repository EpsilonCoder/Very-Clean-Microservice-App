...
class ModeSelectionResourceIT {
    ...
    public static ModeSelection createEntity(EntityManager em) {
        ModeSelection modeSelection = new ModeSelection().libelle(DEFAULT_LIBELLE).code(DEFAULT_CODE).description(DEFAULT_DESCRIPTION);
    ...
    public static ModeSelection createUpdatedEntity(EntityManager em) {
        ModeSelection modeSelection = new ModeSelection().libelle(UPDATED_LIBELLE).code(UPDATED_CODE).description(UPDATED_DESCRIPTION);
        return modeSelection;
    }
    ...
    @Test
    @Transactional
    void putExistingModeSelection() throws Exception {
        // Initialize the database
        modeSelectionRepository.saveAndFlush(modeSelection);
        ...
        updatedModeSelection.libelle(UPDATED_LIBELLE).code(UPDATED_CODE).description(UPDATED_DESCRIPTION);
    ...
    void partialUpdateModeSelectionWithPatch() throws Exception {
        ...
        partialUpdatedModeSelection.libelle(UPDATED_LIBELLE).description(UPDATED_DESCRIPTION);
    ...
    void fullUpdateModeSelectionWithPatch() throws Exception {
        ...
        partialUpdatedModeSelection.libelle(UPDATED_LIBELLE).code(UPDATED_CODE).description(UPDATED_DESCRIPTION);
    ...
    void deleteModeSelection() throws Exception {
        ...
        restModeSelectionMockMvc
            .perform(delete(ENTITY_API_URL_ID, modeSelection.getId()).with(csrf()).accept(MediaType.APPLICATION_JSON))
