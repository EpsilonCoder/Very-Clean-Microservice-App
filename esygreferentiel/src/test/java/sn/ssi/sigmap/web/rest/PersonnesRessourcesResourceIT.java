...
class PersonnesRessourcesResourceIT {
    ...
    @Test
    @Transactional
    void putExistingPersonnesRessources() throws Exception {
        // Initialize the database
        personnesRessourcesRepository.saveAndFlush(personnesRessources);
    ...
    void partialUpdatePersonnesRessourcesWithPatch() throws Exception {
        ...
        partialUpdatedPersonnesRessources.email(UPDATED_EMAIL).fonction(UPDATED_FONCTION);
    ...
    void deletePersonnesRessources() throws Exception {
        ...
        restPersonnesRessourcesMockMvc
            .perform(delete(ENTITY_API_URL_ID, personnesRessources.getId()).with(csrf()).accept(MediaType.APPLICATION_JSON))
