...
class TypeAutoriteContractanteResourceIT {
    ...
    @Test
    @Transactional
    void checkChapitreIsRequired() throws Exception {
        int databaseSizeBeforeTest = typeAutoriteContractanteRepository.findAll().size();
        // set the field null
    ...
    @Test
    @Transactional
    void putExistingTypeAutoriteContractante() throws Exception {
        // Initialize the database
        typeAutoriteContractanteRepository.saveAndFlush(typeAutoriteContractante);
        ...
        updatedTypeAutoriteContractante
            .libelle(UPDATED_LIBELLE)
            .code(UPDATED_CODE)
            .description(UPDATED_DESCRIPTION)
            .ordre(UPDATED_ORDRE)
    ...
    void deleteTypeAutoriteContractante() throws Exception {
        ...
        restTypeAutoriteContractanteMockMvc
            .perform(delete(ENTITY_API_URL_ID, typeAutoriteContractante.getId()).with(csrf()).accept(MediaType.APPLICATION_JSON))
