...
describe('GroupesImputation Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'groupes-imputation', component: GroupesImputationComponent }]),
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.groupesImputations?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to groupesImputationService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getGroupesImputationIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getGroupesImputationIdentifier).toHaveBeenCalledWith(entity);
