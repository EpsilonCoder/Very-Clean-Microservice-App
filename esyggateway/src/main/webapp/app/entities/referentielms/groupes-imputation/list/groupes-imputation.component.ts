...
import { EntityArrayResponseType, GroupesImputationService } from '../service/groupes-imputation.service';
...
export class GroupesImputationComponent implements OnInit {
  ...
  trackId = (_index: number, item: IGroupesImputation): number => this.groupesImputationService.getGroupesImputationIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.groupesImputations = dataFromBody;
  }

  protected fillComponentAttributesFromResponseBody(data: IGroupesImputation[] | null): IGroupesImputation[] {
    return data ?? [];
  }
  ...
  protected queryBackend(page?: number, predicate?: string, ascending?: boolean): Observable<EntityArrayResponseType> {
    ...
    return this.groupesImputationService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
