...
describe('Hierarchie Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'hierarchie', component: HierarchieComponent }]), HttpClientTestingModule],
  ...
  describe('trackId', () => {
    it('Should forward to hierarchieService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getHierarchieIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getHierarchieIdentifier).toHaveBeenCalledWith(entity);
