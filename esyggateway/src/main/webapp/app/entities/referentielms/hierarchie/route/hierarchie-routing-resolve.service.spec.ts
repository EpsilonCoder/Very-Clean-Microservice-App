...
describe('Hierarchie routing resolve service', () => {
  ...
  let resultHierarchie: IHierarchie | null | undefined;
  ...
  describe('resolve', () => {
    ...
    it('should return null if id is not provided', () => {
      ...
      expect(resultHierarchie).toEqual(null);
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<IHierarchie>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
