...
import { sampleWithRequiredData, sampleWithNewData, sampleWithPartialData, sampleWithFullData } from '../hierarchie.test-samples';

import { HierarchieService } from './hierarchie.service';

const requireRestSample: IHierarchie = {
...
describe('Hierarchie Service', () => {
  ...
  describe('Service methods', () => {
    ...
    it('should create a Hierarchie', () => {
      ...
      const hierarchie = { ...sampleWithNewData };
      const returnedFromService = { ...requireRestSample };
      const expected = { ...sampleWithRequiredData };

      service.create(hierarchie).subscribe(resp => (expectedResult = resp.body));
    ...
    it('should update a Hierarchie', () => {
      const hierarchie = { ...sampleWithRequiredData };
      const returnedFromService = { ...requireRestSample };
      const expected = { ...sampleWithRequiredData };

      service.update(hierarchie).subscribe(resp => (expectedResult = resp.body));
    ...
    describe('addHierarchieToCollectionIfMissing', () => {
      it('should add a Hierarchie to an empty array', () => {
        const hierarchie: IHierarchie = sampleWithRequiredData;
      ...
      it("should add a Hierarchie to an array that doesn't contain it", () => {
        const hierarchie: IHierarchie = sampleWithRequiredData;
        const hierarchieCollection: IHierarchie[] = [sampleWithPartialData];
        expectedResult = service.addHierarchieToCollectionIfMissing(hierarchieCollection, hierarchie);
        expect(expectedResult).toHaveLength(2);
        expect(expectedResult).toContain(hierarchie);
      });
      ...
      it('should add only unique Hierarchie to an array', () => {
        const hierarchieArray: IHierarchie[] = [sampleWithRequiredData, sampleWithPartialData, sampleWithFullData];
        const hierarchieCollection: IHierarchie[] = [sampleWithRequiredData];
      ...
      it('should accept varargs', () => {
        const hierarchie: IHierarchie = sampleWithRequiredData;
        const hierarchie2: IHierarchie = sampleWithPartialData;
    ...
    describe('compareHierarchie', () => {
      it('Should return true if both entities are null', () => {
        const entity1 = null;
        const entity2 = null;

        const compareResult = service.compareHierarchie(entity1, entity2);
      ...
      it('Should return false if one entity is null', () => {
        ...
        const compareResult1 = service.compareHierarchie(entity1, entity2);
        const compareResult2 = service.compareHierarchie(entity2, entity1);
