...
describe('CategorieFournisseur Management Component', () => {
  let comp: CategorieFournisseurComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'categorie-fournisseur', component: CategorieFournisseurComponent }]),
      ...
      .overrideTemplate(CategorieFournisseurComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.categorieFournisseurs?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to categorieFournisseurService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getCategorieFournisseurIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getCategorieFournisseurIdentifier).toHaveBeenCalledWith(entity);
