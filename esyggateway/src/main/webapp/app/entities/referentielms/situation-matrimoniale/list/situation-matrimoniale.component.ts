...
import { EntityArrayResponseType, SituationMatrimonialeService } from '../service/situation-matrimoniale.service';
...
export class SituationMatrimonialeComponent implements OnInit {
  ...
  trackId = (_index: number, item: ISituationMatrimoniale): number =>
    this.situationMatrimonialeService.getSituationMatrimonialeIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.situationMatrimoniales = dataFromBody;
  }

  protected fillComponentAttributesFromResponseBody(data: ISituationMatrimoniale[] | null): ISituationMatrimoniale[] {
    return data ?? [];
  }
  ...
  protected queryBackend(page?: number, predicate?: string, ascending?: boolean): Observable<EntityArrayResponseType> {
    ...
    return this.situationMatrimonialeService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
