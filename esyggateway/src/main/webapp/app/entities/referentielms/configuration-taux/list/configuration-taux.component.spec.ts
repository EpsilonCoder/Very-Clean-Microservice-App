...
describe('ConfigurationTaux Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'configuration-taux', component: ConfigurationTauxComponent }]),
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.configurationTauxes?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to configurationTauxService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getConfigurationTauxIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getConfigurationTauxIdentifier).toHaveBeenCalledWith(entity);
