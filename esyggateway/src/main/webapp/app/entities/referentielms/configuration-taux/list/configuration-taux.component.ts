...
import { EntityArrayResponseType, ConfigurationTauxService } from '../service/configuration-taux.service';
...
export class ConfigurationTauxComponent implements OnInit {
  ...
  trackId = (_index: number, item: IConfigurationTaux): number => this.configurationTauxService.getConfigurationTauxIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.configurationTauxes = dataFromBody;
  }

  protected fillComponentAttributesFromResponseBody(data: IConfigurationTaux[] | null): IConfigurationTaux[] {
    return data ?? [];
  }
  ...
  protected queryBackend(page?: number, predicate?: string, ascending?: boolean): Observable<EntityArrayResponseType> {
    ...
    return this.configurationTauxService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
