...
describe('Pays Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'pays', component: PaysComponent }]), HttpClientTestingModule],
  ...
  describe('trackId', () => {
    it('Should forward to paysService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getPaysIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getPaysIdentifier).toHaveBeenCalledWith(entity);
