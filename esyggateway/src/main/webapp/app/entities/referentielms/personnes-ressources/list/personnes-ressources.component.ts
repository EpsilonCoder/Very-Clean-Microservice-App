...
import { EntityArrayResponseType, PersonnesRessourcesService } from '../service/personnes-ressources.service';
...
export class PersonnesRessourcesComponent implements OnInit {
  ...
  trackId = (_index: number, item: IPersonnesRessources): number => this.personnesRessourcesService.getPersonnesRessourcesIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.personnesRessources = dataFromBody;
  }

  protected fillComponentAttributesFromResponseBody(data: IPersonnesRessources[] | null): IPersonnesRessources[] {
    return data ?? [];
  }
  ...
  protected queryBackend(page?: number, predicate?: string, ascending?: boolean): Observable<EntityArrayResponseType> {
    ...
    return this.personnesRessourcesService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
