...
describe('PersonnesRessources Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'personnes-ressources', component: PersonnesRessourcesComponent }]),
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.personnesRessources?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to personnesRessourcesService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getPersonnesRessourcesIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getPersonnesRessourcesIdentifier).toHaveBeenCalledWith(entity);
