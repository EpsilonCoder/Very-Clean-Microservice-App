...
describe('JoursFeries Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'jours-feries', component: JoursFeriesComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.joursFeries?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to joursFeriesService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getJoursFeriesIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getJoursFeriesIdentifier).toHaveBeenCalledWith(entity);
