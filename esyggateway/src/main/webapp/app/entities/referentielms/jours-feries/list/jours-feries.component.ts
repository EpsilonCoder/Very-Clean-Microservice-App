...
import { EntityArrayResponseType, JoursFeriesService } from '../service/jours-feries.service';
...
export class JoursFeriesComponent implements OnInit {
  ...
  trackId = (_index: number, item: IJoursFeries): number => this.joursFeriesService.getJoursFeriesIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.joursFeries = dataFromBody;
  }

  protected fillComponentAttributesFromResponseBody(data: IJoursFeries[] | null): IJoursFeries[] {
    return data ?? [];
  }
  ...
  protected queryBackend(page?: number, predicate?: string, ascending?: boolean): Observable<EntityArrayResponseType> {
    ...
    return this.joursFeriesService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
