...
describe('SygAutoriteContractante Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'syg-autorite-contractante', component: SygAutoriteContractanteComponent }]),
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.sygAutoriteContractantes?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to sygAutoriteContractanteService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getSygAutoriteContractanteIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getSygAutoriteContractanteIdentifier).toHaveBeenCalledWith(entity);
