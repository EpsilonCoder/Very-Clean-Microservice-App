...
import { EntityArrayResponseType, SygAutoriteContractanteService } from '../service/syg-autorite-contractante.service';
...
export class SygAutoriteContractanteComponent implements OnInit {
  ...
  trackId = (_index: number, item: ISygAutoriteContractante): number =>
    this.sygAutoriteContractanteService.getSygAutoriteContractanteIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.sygAutoriteContractantes = dataFromBody;
  }

  protected fillComponentAttributesFromResponseBody(data: ISygAutoriteContractante[] | null): ISygAutoriteContractante[] {
    return data ?? [];
  }
  ...
  protected queryBackend(page?: number, predicate?: string, ascending?: boolean): Observable<EntityArrayResponseType> {
    ...
    return this.sygAutoriteContractanteService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
