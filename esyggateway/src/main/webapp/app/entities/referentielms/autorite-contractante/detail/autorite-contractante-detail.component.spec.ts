...
import { AutoriteContractanteDetailComponent } from './autorite-contractante-detail.component';
...
describe('AutoriteContractante Management Detail Component', () => {
      ...
      providers: [
        {
          ...
          useValue: { data: of({ autoriteContractante: { id: 123 } }) },
        },
      ],
    })
  ...
  describe('OnInit', () => {
    it('Should load autoriteContractante on init', () => {
      ...
      // THEN
      expect(comp.autoriteContractante).toEqual(expect.objectContaining({ id: 123 }));
    });
  });
