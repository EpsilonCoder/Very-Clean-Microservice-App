...
describe('SpecialitesPersonnel Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'specialites-personnel', component: SpecialitesPersonnelComponent }]),
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.specialitesPersonnels?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to specialitesPersonnelService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getSpecialitesPersonnelIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getSpecialitesPersonnelIdentifier).toHaveBeenCalledWith(entity);
