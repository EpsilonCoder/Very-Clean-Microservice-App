...
import { EntityArrayResponseType, SpecialitesPersonnelService } from '../service/specialites-personnel.service';
...
export class SpecialitesPersonnelComponent implements OnInit {
  ...
  trackId = (_index: number, item: ISpecialitesPersonnel): number =>
    this.specialitesPersonnelService.getSpecialitesPersonnelIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.specialitesPersonnels = dataFromBody;
  }

  protected fillComponentAttributesFromResponseBody(data: ISpecialitesPersonnel[] | null): ISpecialitesPersonnel[] {
    return data ?? [];
  }
  ...
  protected queryBackend(page?: number, predicate?: string, ascending?: boolean): Observable<EntityArrayResponseType> {
    ...
    return this.specialitesPersonnelService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
