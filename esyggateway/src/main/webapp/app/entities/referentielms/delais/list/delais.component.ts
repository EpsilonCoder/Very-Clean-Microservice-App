...
import { EntityArrayResponseType, DelaisService } from '../service/delais.service';
...
export class DelaisComponent implements OnInit {
  ...
  trackId = (_index: number, item: IDelais): number => this.delaisService.getDelaisIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.delais = dataFromBody;
  }

  protected fillComponentAttributesFromResponseBody(data: IDelais[] | null): IDelais[] {
    return data ?? [];
  }
  ...
  protected queryBackend(page?: number, predicate?: string, ascending?: boolean): Observable<EntityArrayResponseType> {
    ...
    return this.delaisService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
