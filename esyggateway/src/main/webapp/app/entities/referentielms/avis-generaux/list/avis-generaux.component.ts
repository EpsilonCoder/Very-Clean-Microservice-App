...
import { EntityArrayResponseType, AvisGenerauxService } from '../service/avis-generaux.service';
...
export class AvisGenerauxComponent implements OnInit {
  ...
  trackId = (_index: number, item: IAvisGeneraux): number => this.avisGenerauxService.getAvisGenerauxIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.avisGenerauxes = dataFromBody;
  }

  protected fillComponentAttributesFromResponseBody(data: IAvisGeneraux[] | null): IAvisGeneraux[] {
    return data ?? [];
  }
  ...
  protected queryBackend(page?: number, predicate?: string, ascending?: boolean): Observable<EntityArrayResponseType> {
    ...
    return this.avisGenerauxService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
