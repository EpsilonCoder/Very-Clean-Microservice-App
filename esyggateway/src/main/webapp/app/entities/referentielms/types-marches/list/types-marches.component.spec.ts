...
describe('TypesMarches Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'types-marches', component: TypesMarchesComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.typesMarches?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to typesMarchesService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getTypesMarchesIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getTypesMarchesIdentifier).toHaveBeenCalledWith(entity);
