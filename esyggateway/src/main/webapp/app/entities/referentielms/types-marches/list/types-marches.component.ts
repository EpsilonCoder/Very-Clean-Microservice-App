...
import { EntityArrayResponseType, TypesMarchesService } from '../service/types-marches.service';
...
export class TypesMarchesComponent implements OnInit {
  ...
  trackId = (_index: number, item: ITypesMarches): number => this.typesMarchesService.getTypesMarchesIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.typesMarches = dataFromBody;
  }

  protected fillComponentAttributesFromResponseBody(data: ITypesMarches[] | null): ITypesMarches[] {
    return data ?? [];
  }
  ...
  protected queryBackend(page?: number, predicate?: string, ascending?: boolean): Observable<EntityArrayResponseType> {
    ...
    return this.typesMarchesService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
