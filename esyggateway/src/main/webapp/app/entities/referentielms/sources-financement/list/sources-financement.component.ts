...
import { EntityArrayResponseType, SourcesFinancementService } from '../service/sources-financement.service';
...
export class SourcesFinancementComponent implements OnInit {
  ...
  trackId = (_index: number, item: ISourcesFinancement): number => this.sourcesFinancementService.getSourcesFinancementIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.sourcesFinancements = dataFromBody;
  }

  protected fillComponentAttributesFromResponseBody(data: ISourcesFinancement[] | null): ISourcesFinancement[] {
    return data ?? [];
  }
  ...
  protected queryBackend(page?: number, predicate?: string, ascending?: boolean): Observable<EntityArrayResponseType> {
    ...
    return this.sourcesFinancementService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
