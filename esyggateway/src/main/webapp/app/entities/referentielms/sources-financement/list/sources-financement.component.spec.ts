...
describe('SourcesFinancement Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'sources-financement', component: SourcesFinancementComponent }]),
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.sourcesFinancements?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to sourcesFinancementService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getSourcesFinancementIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getSourcesFinancementIdentifier).toHaveBeenCalledWith(entity);
