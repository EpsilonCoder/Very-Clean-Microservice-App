...
import { EntityArrayResponseType, CriteresQualificationService } from '../service/criteres-qualification.service';
...
export class CriteresQualificationComponent implements OnInit {
  ...
  trackId = (_index: number, item: ICriteresQualification): number =>
    this.criteresQualificationService.getCriteresQualificationIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.criteresQualifications = dataFromBody;
  }

  protected fillComponentAttributesFromResponseBody(data: ICriteresQualification[] | null): ICriteresQualification[] {
    return data ?? [];
  }
  ...
  protected queryBackend(page?: number, predicate?: string, ascending?: boolean): Observable<EntityArrayResponseType> {
    ...
    return this.criteresQualificationService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
