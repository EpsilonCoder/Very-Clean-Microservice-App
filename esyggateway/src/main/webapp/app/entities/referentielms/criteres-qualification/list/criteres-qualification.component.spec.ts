...
describe('CriteresQualification Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'criteres-qualification', component: CriteresQualificationComponent }]),
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.criteresQualifications?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to criteresQualificationService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getCriteresQualificationIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getCriteresQualificationIdentifier).toHaveBeenCalledWith(entity);
