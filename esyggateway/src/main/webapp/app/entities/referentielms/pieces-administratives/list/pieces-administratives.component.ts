...
import { EntityArrayResponseType, PiecesAdministrativesService } from '../service/pieces-administratives.service';
...
export class PiecesAdministrativesComponent implements OnInit {
  ...
  trackId = (_index: number, item: IPiecesAdministratives): number =>
    this.piecesAdministrativesService.getPiecesAdministrativesIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.piecesAdministratives = dataFromBody;
  }

  protected fillComponentAttributesFromResponseBody(data: IPiecesAdministratives[] | null): IPiecesAdministratives[] {
    return data ?? [];
  }
  ...
  protected queryBackend(page?: number, predicate?: string, ascending?: boolean): Observable<EntityArrayResponseType> {
    ...
    return this.piecesAdministrativesService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
