...
describe('PiecesAdministratives Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'pieces-administratives', component: PiecesAdministrativesComponent }]),
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.piecesAdministratives?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to piecesAdministrativesService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getPiecesAdministrativesIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getPiecesAdministrativesIdentifier).toHaveBeenCalledWith(entity);
