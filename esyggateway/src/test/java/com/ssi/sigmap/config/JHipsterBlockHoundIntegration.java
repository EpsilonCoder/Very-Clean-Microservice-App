...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.ssi.sigmap.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.ssi.sigmap.security.DomainUserDetailsService", "createSpringSecurityUser");
    }
}
