...
To build the final jar and optimize the esyggateway application for production, run:
...
Then navigate to [http://localhost:2009](http://localhost:2009) in your browser.
